...
import com.roiland.crm.sm.ui.adapter.SmAttachListAdapter;
 ...
 * @author liuyu
 * @version $Id: SmAttachListFragment.java, v 0.1 2013-5-22 上午10:04:45 liuyu Exp $
 */
@SuppressLint("ValidFragment")
public class SmAttachListFragment extends BaseListFragment {
	List<Attach> attachList; //文档图片列表
	SmAttachListAdapter listAdapter; //adapter of listview
	 ...
	 */
	public SmAttachListFragment(String projectID, String customerID) {
		super();
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		listAdapter = new SmAttachListAdapter(this.getActivity());
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(getActivity(), SmAttachInfoActivity.class);
