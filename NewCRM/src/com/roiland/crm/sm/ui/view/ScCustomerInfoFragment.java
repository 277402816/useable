...
//            customerInfo.add(new BasicInfoListAdapter.Info(getString(R.string.gender), BaseInfoRowViewItem.SELECTION_TYPE, new String[] {"客户性别1", "客户性别2", "客户性别3"}, (customer != null ? customer.getGender() : null),false));
          ...
          //购车客户不能休眠
            ...
            temp.dataChangeListener = new BasicInfoListAdapter.Info.DataChangeListener() {
                ...
                public void chagedData(String key, String value) {
                    ...
                    if ("true".equals(value)) {
                        DialogUtils.confirm(getActivity(), "", "是否放弃线索", 
                                new Runnable() {
                                ...
                                new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        customer.setAbandonProject(false);
                                    }
                                });
                    } else {
                        customer.setAbandonProject(false);
			...
			idnumberInfo.textChangeListener = new BasicInfoListAdapter.Info.TextChangeListener() {
				...
				public void textChanged(String key, String value) {
					...
					try {
						...
						customerInfoAdapter.getView(11, null, null);
					} catch (Exception e) {
						e.printStackTrace();
					}
				}
            ...
            customerInfo.add(new BasicInfoListAdapter.Info(getString(R.string.existingcarbrand), BaseInfoRowViewItem.SELECTION_TYPE, null, (customer != null ? customer.getExistingCarBrand() : null),false));
            ...
            customerInfo.add(new BasicInfoListAdapter.Info(getString(R.string.rebuyStoreCustTag), BaseInfoRowViewItem.BOOLEAN2_TYPE, null, (customer != null ? (customer.getRebuyStoreCustTag() ? "true" : "false") : null),false));
