...
import com.roiland.crm.sm.ui.adapter.ScTestDriveListAdapter;
 ...
 * @author liuyu
 * @version $Id: ScTestDriveListFragment.java, v 0.1 2013-7-2 下午2:36:34 liuyu Exp $
 */

public class ScTestDriveListFragment extends BaseListFragment {
	...
	public void displayList(List<DriveTest> dataList) {
		ScTestDriveListAdapter adapter = new ScTestDriveListAdapter(activity);
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(getActivity(), ScTestDriveInfoActivity.class);
