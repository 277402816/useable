 ...
 *
 * @author shuang.gao
 * @version $Id: SmAttachListAdapter.java, v 0.1 2013-8-2 下午4:54:45 shuang.gao Exp $
 */
public class SmAttachListAdapter extends BaseCacheListAdapter<Attach> {

	public SmAttachListAdapter(Context context) {
		super(context);
	}
	
	@Override
	public View getView(int position, View convertView, ViewGroup parent) {
		return super.getView(position, convertView, parent, R.layout.sm_photo_list_item);
	}
