 ...
 *
 * @author shuang.gao
 * @version $Id: GlobalConstant.java, v 0.1 2013-8-2 上午9:18:36 shuang.gao Exp $
 */
public class GlobalConstant {
    ...
    public interface URLContact {
    	public static final String JSON_PREFIX = "jsonString";
     	public static final String EXTENSION_PATH = "/crmserver/";

        public static final String BASE_URL = "http://%s" + EXTENSION_PATH;
    	public static final String METHOD＿LOGIN = BASE_URL + "login.do";
    	public static final String METHOD_TODAY_WORK_CONTENT = BASE_URL + "getTodayWorkContent.do";
    	
    	public static final String METHOD_CUSTOMER_LIST = BASE_URL + "getCustomerList.do";

    	public static final String METHOD_GET_ORDER_NO = BASE_URL + "getOrderNo.do";
    	public static final String METHOD_IS_PROJECT_ACTIVE = BASE_URL + "isProjectActive.do";
    	public static final String METHOD_IS_ROLE_FOR_MATCH = BASE_URL + "isRoleForMatch.do";
    	public static final String METHOD_CREATE_ORDER = BASE_URL + "createOrder.do";
    	public static final String METHOD_GET_ORDER_LIST = BASE_URL + "getOrderList.do";
        public static final String METHOD_GET_THREEDAYS_DELIVERY_ORDER_LIST = BASE_URL + "getThreeDaysDeliveryOrderList.do";
    	public static final String METHOD_GET_ORDER_DETAIL_INFO = BASE_URL + "getOrderDetailInfo.do";
    	public static final String METHOD_UPDATE_ORDER = BASE_URL + "updateOrder.do";
    	public static final String METHOD_SUBMIT_RES_REQUIREMENT = BASE_URL + "submitResRequirement.do";
    	
    	public static final String METHOD_GET_PROJECT_LIST = BASE_URL + "getProjectList.do";
    	public static final String METHOD_GET_PROJECT_INFO = BASE_URL + "getProjectInfo.do";
    	public static final String METHOD_CREATE_PROJECT = BASE_URL + "createProject.do";
    	public static final String METHOD_UPDATE_PROJECT_INFO = BASE_URL + "updateProjectInfo.do";
    	
    	public static final String METHOD_GET_CAR_RES_LIST = BASE_URL + "getCarResList.do";
    	
    	public static final String METHOD_GET_CONTACTER_LIST = BASE_URL + "getContacterList.do";
    	public static final String METHOD_CREATE_CONTACTER = BASE_URL + "createContacter.do";
    	public static final String METHOD_UPDATE_CONTACTER = BASE_URL + "updateContacter.do";
    	
    	public static final String METHOD_GET_CUSTOMER_LIST = BASE_URL + "getCustomerList.do";
    	public static final String METHOD_GET_CUSTOMER_DETAIL = BASE_URL + "getCustomerDetail.do";
    	public static final String METHOD_UPDATE_CUSTOMER = BASE_URL + "updateCustomer.do";
    	public static final String METHOD_GET_CUSTOMER_CAR_INTENTION = BASE_URL + "getCustomerCarIntention.do";
    	public static final String METHOD_GET_OLD_CUSTOMER = BASE_URL + "getOldCustomer.do";
        public static final String METHOD_NOACTION_PLAN_PROJECT_COUNT = BASE_URL + "noPlanCustomerList.do";
        public static final String METHOD_ASSIGN_CUSTOMER = BASE_URL + "assignCustomer.do";

    	public static final String METHOD_GET_ATTACHMENT_LIST = BASE_URL + "getAttachmentList.do";
    	public static final String METHOD_UPLOAD_DOCUMENT = BASE_URL + "uploadDocument.do";
    	public static final String METHOD_DOWNLOAD_FILE = BASE_URL + "downloadFile.do";
    	
    	public static final String METHOD_GET_TRACEPLAN_LIST = BASE_URL + "getTracePlanList.do";
    	public static final String METHOD_CREATE_TRACEPLAN = BASE_URL + "createTracePlan.do";
    	public static final String METHOD_UPDATE_TRACEPLAN = BASE_URL + "updateTracePlan.do";
        public static final String METHOD_ADV_SEARCH_TRACEPLAN = BASE_URL + "advSearchTracePlan.do";
        public static final String METHOD_GET_TODAY_ACTION_PLAN_LIST = BASE_URL+"getTodayActionPlanList.do";
        public static final String METHOD_GET_EXPIRED_ACTION_PLAN_LIST = BASE_URL+"getExpiredActionPlanList.do";
    	public static final String METHOD_CREATE_DRIVETEST = BASE_URL + "createDriveTest.do";
    	public static final String METHOD_UPDATE_DRIVETEST = BASE_URL + "updateDriveTest.do";
    	public static final String METHOD_GET_DRIVETEST_LIST = BASE_URL + "getDriveTestList.do";
    	
    	public static final String METHOD_GET_DICTIONARY = BASE_URL + "getDictionary.do";
    	public static final String METHOD_GET_CASCADEDICT = BASE_URL + "getCascadeDict.do";

    	public static final String METHOD_GET_PROJECT_DRIVETES_LIST = BASE_URL + "getProjectDriveTest.do";
    	public static final String METHOD_GET_CUSTOMER_PROJECT_LIST = BASE_URL + "getCustomerProjectList.do";
    	public static final String METHOD_GET_IS_EXIST_PROJECT = BASE_URL + "isExistProject.do";
    	public static final String METHOD_SYNC_CONTACTER = BASE_URL + "syncContacter.do";
    	public static final String METHOD_GET_EMPLOYEE_LIST = BASE_URL+"getEmployeeList.do";
    	public static final String METHOD_GET_TODAY_PROJECT_LIST = BASE_URL+"getTodayProjectList.do";
    	public static final String METHOD_GET_EXPIRED_PROJECT_LIST = BASE_URL+"getExpiredProjectList.do";
        public static final String METHOD_GET_SEARCH_PROJECT_FUNNEL = BASE_URL+"getFunnelInfo.do";
        
        public static final String METHOD_GET_VERSION = BASE_URL + "getAndrVersion.do";
    }
    
    public interface DictionaryKeyConstant {
    	public static final String COLLECT_WAY_DIC_KEY = "dicCollectWay";
    	public static final String BRAND_DIC_KEY = "dicBrand";
    	public static final String MODEL_DIC_KEY = "dicModel";
    	public static final String PROVINCE_KEY = "dicProvince";
    	...
    	public static final String CUSTOMER_CFG_DIC_KEY = "customerCfg";
    	public static final String UNPRO_FILE_REASON_DIC_KEY = "dicUnprofileReason";
    	public static final String INFO_FROM_DIC_KEY = "dicInfoFrom";
    	public static final String ACCOM_RELA_DIC_KEY = "dicAccomRela";
    	public static final String PURCHASE_EXPE_DIC_KEY = "dicPurchaseExpe";
    	public static final String CUSTOMER_FROM_DIC_KEY = "dicCustomerFrom";
    	public static final String CUSTOMER_TYPE_DIC_KEY = "dicCustomerType";
    	public static final String CARD_TYPE_DIC_KEY = "dicCardType";
    	public static final String PROVINCE_DIC_KEY = "dicProvince";
    	public static final String CITY_DIC_KEY = "dicCity";
    	public static final String DISTRICT_DIC_KEY = "dicDistrict";
    	public static final String INDUSTRY_DIC_KEY = "dicIndustry";
    	public static final String POSITION_DIC_KEY = "dicPosition";
    	public static final String EDUCATION_DIC_KEY = "dicEducation";
    	public static final String INTEREST_DIC_KEY = "dicInterest";
    	public static final String ENTERP_TYPE_DIC_KEY = "dicEnterpType";
    	public static final String ENTERP_PEOPLE_DIC_KEY = "dicEnterpPeople";
    	public static final String REGISTERED_DIC_KEY = "dicRegistered";
    	public static final String COMPE_CAR_MODEL_DIC_KEY = "dicCompeCarModel";
    	public static final String OUTSIDE_COLOR_DIC_KEY = "dicOutsideColor";
    	public static final String INSIDE_COLOR_DIC_KEY = "dicInsideColor";
    	public static final String CAR_CONFIGURATION_DIC_KEY = "dicCarConfiguration";
    	public static final String DEAL_PRICE_INTERVAL_DIC_KEY = "dicDealPriceInterval";
    	public static final String PAYMENT_DIC_KEY = "dicPayment";
    	public static final String FLOW_STATUS_DIC_KEY = "dicFlowStatus";
    	public static final String PURCH_MOTIVATION_DIC_KEY = "dicPurchMotivation";
    	public static final String GIVEUP_REASON_DIC_KEY = "dicGiveupReason";
    	public static final String ACTIVITY_TYPE_DIC_KEY = "dicActivityType";
    	public static final String EXECUTE_STATUS_DIC_KEY = "dicExecuteStatus";
    	public static final String ORDER_TYPE_DIC_KEY = "dicOrderType";
    	public static final String ORDER_VEHI_TYPE_DIC_KEY = "dicOrderVehiType";
    	public static final String ORDER_PRIORITY_DIC_KEY = "dicOrderPriority";
    	public static final String NOW_CAR_TYPE_DIC_KEY = "dicNowCarType";
    	public static final String CONTRACT_TIME_DIC_KEY = "dicContractTime";
    	public static final String PZH_DIC_KEY = "dicPZH";
    	public static final String SEX_DIC_KEY = "dicSex";
    	public static final String CONTACT_DIC_KEY = "dicContact";
    	public static final String Dkh_DIC_KEY = "dicDkh";
    	public static final String AGE_SCOPE_DIC_KEY = "dicAgeScope";
    	public static final String CONT_TYPE_DIC_KEY = "diccontType";
    	public static final String CONT_RELATION_DIC_KEY = "dicContRelation";
    	public static final String JOIN_CAR_PLACE_DIC_KEY = "dicJoinCarPlace";
    	public static final String VISITSTDIC_ORDER_GIVEUP_REASONATUS_DIC_KY = "dicVisitstdicOrderGiveupReasonatus";
    	public static final String SHIJIA_STA_DIC_KEY = "dicShijiaSta";
    	public static final String DEAL_POSSIBILITY_DIC_KEY = "dicDealPossibility";
    }
    
    public interface DBContact {
    	public static final String DB_NAME = "com.roiland.crm.CRM.db";
    ...
    public static final String FIRST_LETTER_ARRAY = 
    ...
    public static String pinyinFirstLetter(String letter) {
    	if (letter == null || letter.length() == 0)
    		return "";
    		
    	char character = letter.charAt(0);
    	if (character >= HANZI_START && character < HANZI_START + HANZI_COUNT) {
    		return FIRST_LETTER_ARRAY.substring(character- HANZI_START, character- HANZI_START + 1);
    	} else {
