 ...
 * @author liuyu
 * @version $Id: SmCustomerOrderInfoActivity.java, v 0.1 2013-5-17 上午11:21:01 liuyu Exp $
 */

public class SmCustomerOrderInfoActivity extends BaseInfoActivity implements BottomEventListener{
    public String orderId = null;
    private CustOrder customerOrder;
	private BottomBar bBar;
	private SmCustomerOrderInfoFragment orderFragment;
	
	public SmCustomerOrderInfoActivity(){
		super();
		orderFragment = new SmCustomerOrderInfoFragment(customerOrder);
	}
	...
	public void bottomTabClick(int tabIndex) {
		...
		case BottomBar.TAB_INDEX_SALES_OPPO:
			if (orderFragment != null && orderFragment.getCustOrder() != null && orderFragment.getCustOrder().getCustomer() != null) {
				Intent oppIntent = new Intent(this, SmOppoInfoActivity.class);
