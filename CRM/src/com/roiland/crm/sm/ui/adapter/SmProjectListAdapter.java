 ...
 */
public class SmProjectListAdapter extends SeparatedListAdapter<Project> {

    public SmProjectListAdapter(Context context) {
        super(context, R.layout.sm_list_complex);
    }
    ...
    protected View getContentView(int headerPosition, int position,
        ...
        try {
            ...
            ((TextView) view.findViewById(R.id.list_complex_owner))
            .setText(StringUtils.notNull(item.getPurchaseCarIntention().getEmployeeName()));
