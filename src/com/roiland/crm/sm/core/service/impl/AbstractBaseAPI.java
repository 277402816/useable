...
import com.roiland.crm.sm.core.http.AbstractRLHttpClient;
import com.roiland.crm.sm.core.http.HttpClientInterface;
import com.roiland.crm.sm.core.http.PooledHttpClient;
...
public abstract class AbstractBaseAPI {
    ...
    public synchronized PooledHttpClient getHttpClient() {
        if (poolHttpClient == null) {
            poolHttpClient = new PooledHttpClient(RLHttpClient.CONNECT_TIMEOUT, RLHttpClient.SOCKET_TIMEOUT, 3);
        }
//        if (httpClient == null) {
//            httpClient = new RLHttpClient();
//        }
        return poolHttpClient;//.getRLHttpClient();
    }

    public void setHttpClient(AbstractRLHttpClient httpClient) {
